...
def crewai_tool_gate(
    *,
    policy: dict[str, Any] | None = None,
    default_ctx: GateContext | dict[str, Any] | None = None,
) -> Callable[..., ToolGateResponse]:
    """Thin CrewAI-oriented gate wrapper.

    This helper does not depend on CrewAI internals; it simply normalizes
    proposed tool calls into `propose(...)`.
    """
